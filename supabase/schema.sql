...
create table values_lexicon (
  id text primary key,
  display_label_adult text not null,
  -- One-line "Evoked definition" touching the truest essence of the value,
  -- shown under it on the pick-from-list screen. See v0.25 migration.
  definition text not null default '',
  sort_order int not null
);

-- Virtues card values minus VIA-strength overlaps, plus Creation + Truth = 44.
-- Definitions Guinan-reviewed (v0.25). Keep in sync with the v0.25 migration.
