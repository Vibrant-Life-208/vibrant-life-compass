const CACHE = 'heros-compass-v202';
const CORE = [
  '/',
  '/index.html',
  '/manifest.json',
  ...
  '/js/pillars/purpose.js',
  '/js/pillars/connection.js',
  '/js/pillars/creator.js',
  '/js/pillars/life-skills.js',
  '/js/pillars/academics.js',
  '/js/observatory/pillar-disc.js',
  '/js/observatory/observatory-stack.js',
  '/js/observatory/asterisms.js',
  '/js/arrive.js',
  '/js/auth.js',
  '/js/family.js',
  '/js/owner.js',
  ...
  '/js/via-parse.js',
  '/js/via-import.js',
  '/js/community-board.js',
  '/js/poster.js',
  '/js/responsibilities.js',
  '/js/setup.js',
  '/js/welcome.js',
